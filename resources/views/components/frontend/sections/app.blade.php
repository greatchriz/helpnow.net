...
<section id="home">
    <div class="container-fluid p-0">
        ...
        <div class="rev_slider_wrapper">
            <div
                class="rev_slider rev_slider_default"
                data-version="5.0"
            >
                <ul>
                    ...
                    <li
                        ...
                        data-thumb="fundpro/images/bg/bg20.jpg"
                        data-rotate="0"
                    ...
                    >
                        <!-- MAIN IMAGE -->
                        <img
                            src="fundpro/images/bg/bg20.jpg"
                            alt=""
                        ...
                        >Every day we bring hope to millions of children in the world's<br> hardest places as a sign of
                    ...
                    <li
                        ...
                        data-easeout="default"
                        data-masterspeed="default"
                        data-thumb="fundpro/images/bg/bg23.jpg"
                        data-rotate="0"
                        data-saveperformance="off"
                        data-title="Slide 1"
                        data-description=""
                    >
                        <!-- MAIN IMAGE -->
                        <img
                            src="fundpro/images/bg/bg23.jpg"
                            alt=""
                            data-bgposition="center center"
                            data-bgfit="cover"
                            data-bgrepeat="no-repeat"
                    ...
                    <li
                        ...
                        data-easeout="default"
                        data-masterspeed="default"
                        data-thumb="fundpro/images/bg/bg24.jpg"
                        data-rotate="0"
                        data-saveperformance="off"
                        data-title="Slide 3"
                        data-description=""
                    >
                        <!-- MAIN IMAGE -->
                        <img
                            src="fundpro/images/bg/bg24.jpg"
                            alt=""
              ...
              $(".rev_slider_default").revolution({
                ...
                navigation: {
                  ...
                  bullets: {
                    ...
                    v_offset:30,
                    space:5,
                    tmp:'<span class="tp-bullet-img-wrap">  <span class="tp-bullet-image"></span></span><span class="tp-bullet-title">home</span>'
                  }
                },
...
<!-- Section: home-boxes -->
<section
    class="layer-overlay overlay-theme-colored-8"
    data-bg-img="fundpro/images/bg/bg10.jpg"
>
            ...
            >
                <div class="col-sm-12 col-md-4">
                    <div class="icon-box p-40 iconbox-theme-colored bg-white border-1px text-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias non nulla placeat, odio,
                            qui dicta alias.</p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 pl-0">
                            <div class="img-hover-border mt-sm-40">
                                <img
                                    class="img-fullwidth"
                                    src="fundpro/images/about/d1.jpg"
                                    alt=""
                                >
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 pl-0 pr-0">
                            <div class="img-hover-border mt-sm-30">
                                <img
                                    class="img-fullwidth"
                                    src="fundpro/images/about/d2.jpg"
                                    alt=""
                                >
                            </div>
                            <div class="img-hover-border mt-15 mt-sm-30">
                                <img
                                    class="img-fullwidth"
                                    src="fundpro/images/about/a4.jpg"
                                    alt=""
                                >
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="about-details">
                        <h2 class="font-36 mt-0"> Welcome to <span class="text-theme-colored">FundPro</span> Please Rise
                            your Helping Hand</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam, odioserunt provident
                            maiores consectetur adipisicing elit. Aliquam odio dese runtesseu provident maiores libero
                            porro dolorem est. Velit necessitatibus fugiat error incidunt excepturi doloribus officia
                            aspernatur quod libero Velit necessitatibus fugiat error incidunt excepturi doloribus
                            officia</p>
                        <div class="singnature mt-20">
                            <img
                                src="fundpro/images/signature.png"
                                alt="img1"
                            >
                        </div>
                        <a
                            href="#"
                            class="btn btn-flat btn-colored btn-theme-colored mt-15 mr-15"
                        >Read More</a><a
                            href="#"
                            class="btn btn-flat btn-colored btn-default btn-theme-colored mt-15"
                        >Get a Quote</a>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel-3col">
                <div class="item">
                    <div class="causes bg-white maxwidth500 mb-30">
                        <div class="thumb">
                            <img
                                src="fundpro/images/project/1.jpg"
                                alt=""
                                class="img-fullwidth"
                            >
                        </div>
                        <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
                            <ul class="list-inline font-20 font-weight-600 clearfix mb-5">
                                <li class="pull-left font-weight-400 text-black-333 pr-0">Raised: <span
                                        class="text-theme-colored font-weight-700"
                                    >$2860</span></li>
                            ...
                            <p class="mt-20">Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos
                                sit.Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                            <a
                                href="page-donate.html"
                                class="btn btn-default btn-theme-colored btn-xs font-16 mt-10"
                            ><i class="flaticon-charity-make-a-donation font-16 ml-5"></i> Donate <i
                ...
                <div class="item">
                    <div class="causes bg-white maxwidth500 mb-30">
                        <div class="thumb">
                            <img
                                src="fundpro/images/project/2.jpg"
                                alt=""
                                class="img-fullwidth"
                            >
                        </div>
                ...
                <div class="item">
                    <div class="causes bg-white maxwidth500 mb-30">
                        <div class="thumb">
                            <img
                                src="fundpro/images/project/3.jpg"
                                alt=""
                                class="img-fullwidth"
                            >
                        </div>
                ...
                <div class="item">
                    <div class="causes bg-white maxwidth500 mb-30">
                        <div class="thumb">
                            <img
                                src="fundpro/images/project/4.jpg"
                                alt=""
                                class="img-fullwidth"
                            >
                        </div>
                        <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
                            ...
                            <h4 class="text-uppercase"><a href="page-single-cause.html">Happiness for orphan child</a>
                            </h4>
                            <div class="progress-item mt-0">
                                <div class="progress mb-0">
                                    <div
                ...
                <div class="item">
                    <div class="causes bg-white maxwidth500 mb-30">
                        <div class="thumb">
                            <img
                                src="fundpro/images/project/5.jpg"
                                alt=""
                                class="img-fullwidth"
                            >
                        </div>
                        <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
                            ...
                            <h4 class="text-uppercase"><a href="page-single-cause.html">Donation for helpless child</a>
                            </h4>
                            <div class="progress-item mt-0">
                                <div class="progress mb-0">
                                    <div
...
<section
    ...
    data-bg-img="fundpro/images/bg/bg4.jpg"
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                <div class="funfact text-center">
                    ...
                    <h2
                        ...
                        data-value="1054"
                        class="animate-number text-white font-42 font-weight-500 mt-0 mb-0"
                    >0</h2>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="icon-box left media bg-silver-light border-1px border-theme-colored p-15 mb-20">
                                <a
                                    ...
                                    href="#"
                                ><i class="flaticon-charity-shaking-hands-inside-a-heart text-theme-colored"></i></a>
                                <div class="media-body">
                                    <h4 class="font-15 text-uppercase">Save The children</h4>
                                    <p>Lorem ipsum dolor sit ametcons ecte adipisicing eli cumconse teturs lorem ipsum
                                        dolor is emmit</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="icon-box left media bg-silver-light border-1px border-theme-colored p-15 mb-20">
                                <a
                                    class="media-left pull-left flip"
                                    href="#"
                                ><i class="flaticon-charity-shelter text-theme-colored"></i></a>
                                <div class="media-body">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="icon-box left media bg-silver-light border-1px border-theme-colored p-15 mb-20">
                                <a
                                    class="media-left pull-left flip"
                                    href="#"
                                ><i class="flaticon-charity-responsible-use-of-water text-theme-colored"></i></a>
                                <div class="media-body">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="icon-box left media bg-silver-light border-1px border-theme-colored p-15 mb-20">
                                <a
                                    class="media-left pull-left flip"
                                    href="#"
                                ><i class="flaticon-charity-make-a-donation text-theme-colored"></i></a>
                                <div class="media-body">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-9 pr-10 pl-10">
                                <div class="event-content mt-10 p-5 pb-0 pt-0">
                                    <h5 class="media-heading font-16 font-weight-600"><a href="#">Event: Help The
                                            Children</a></h5>
                    ...
                    <div class="event media sm-maxwidth400 border-bottom mt-5 mb-0 pt-10 pb-15">
                        <div class="row">
                            ...
                            <div class="col-xs-9 pr-10 pl-10">
                                <div class="event-content mt-10 p-5 pb-0 pt-0">
                                    <h5 class="media-heading font-16 font-weight-600"><a href="#">Event: Foods For
                                            Poor</a></h5>
                                    <ul class="list-inline font-weight-600 text-gray-dimgray">
                    ...
                    <div class="event media sm-maxwidth400 mt-5 mb-0 pt-10 pb-15">
                        <div class="row">
                            ...
                            <div class="col-xs-9 pr-10 pl-10">
                                <div class="event-content mt-10 p-5 pb-0 pt-0">
                                    <h5 class="media-heading font-16 font-weight-600"><a href="#">Event: Save The
                                            Water</a></h5>
                                    <ul class="list-inline font-weight-600 text-gray-dimgray">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                    <div class="team-member clearfix">
                        <div class="team-thumb">
                            <img
                                alt=""
                                src="fundpro/images/team/team1.jpg"
                                class="img-fullwidth"
                            >
                            <div class="overlay">
                                <div class="content">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea iste nihil ex libero
                                        ab esse, dignissimos maxime enim sint laborum.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                    <div class="team-member clearfix">
                        <div class="team-thumb">
                            <img
                                alt=""
                                src="fundpro/images/team/team3.jpg"
                                class="img-fullwidth"
                            >
                            <div class="overlay">
                                <div class="content">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                    <div class="team-member clearfix">
                        <div class="team-thumb">
                            <img
                                alt=""
                                src="fundpro/images/team/team2.jpg"
                                class="img-fullwidth"
                            >
                            <div class="overlay">
                                <div class="content">
        ...
        <div class="section-content text-center">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="text-white">Just call at <span class="text-theme-colored">(01) 234 5678</span> to make a
                        donation</h2>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 sm-text-center mt-40">
                    <img
                        ...
                        src="fundpro/images/photos/v1.png"
                        alt=""
                    >
                </div>
            </div>
...
<section
    class="divider parallax layer-overlay overlay-dark-9"
    data-bg-img="fundpro/images/bg/bg23.jpg"
    data-parallax-ratio="0.7"
>
                        ...
                        <div class="item">
                            <div class="comment border-radius-15px">
                                <p>Lorem ipsum dolor sit ametconse ctetur adipisicing elitvolup tatem error sit qui
                                    dolorem facilis. adipisicing elitvolup tatem error</p>
                            </div>
                            <div class="content mt-20">
                                <div class="thumb pull-right">
                                    <img
                                        class="img-circle"
                                        alt=""
                                        src="fundpro/images/testimonials/s1.jpg"
                                    >
                                </div>
                            ...
                            <div class="content mt-20">
                                <div class="thumb pull-right">
                                    <img
                                        class="img-circle"
                                        alt=""
                                        src="fundpro/images/testimonials/s2.jpg"
                                    >
                                </div>
                                <div class="patient-details text-right pull-right mr-20 mt-10">
                                    <h5 class="text-theme-colored">Jonathan Smith</h5>
                            ...
                            <div class="content mt-20">
                                <div class="thumb pull-right">
                                    <img
                                        class="img-circle"
                                        alt=""
                                        src="fundpro/images/testimonials/s3.jpg"
                                    >
                                </div>
                                <div class="patient-details text-right pull-right mr-20 mt-10">
                                    <h5 class="text-theme-colored">Jonathan Smith</h5>
                    ...
                    >
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md1.jpg"
                                    class="img-fullwidth"
                                >
                                ...
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg1.jpg"
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md2.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg2.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md3.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg3.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md4.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg4.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md5.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg5.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md6.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg6.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md7.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg7.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md8.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg8.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md9.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg9.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md10.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg10.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md11.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg11.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                <img
                                    alt="project"
                                    src="fundpro/images/gallery/gallery-md12.jpg"
                                    class="img-fullwidth"
                                >
                                <div class="overlay-shade"></div>
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a
                                                href="fundpro/images/gallery/gallery-lg12.jpg"
                                                data-lightbox-gallery="gallery"
                                            ><i class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                    ...
                    <article class="post clearfix mb-sm-30 bg-silver-light">
                        ...
                        <div class="bg-theme-colored p-5 text-center pt-10 pb-10">
                            <span class="mb-10 text-white mr-10 font-13"><i
                                    class="fa fa-share-alt mr-5 text-white"></i>24 Share</span>
                            <span class="mb-10 text-white mr-10 font-13"><i
                                    class="fa fa-commenting-o mr-5 text-white"></i> 214 Comments</span>
                            <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-heart-o mr-5 text-white"></i>
                                895 Likes</span>
                        </div>
                            ...
                            <div class="entry-meta media mt-0 no-bg no-border">
                                ...
                                <div class="media-body pl-15">
                                    <div class="event-content pull-left flip">
                                        <h4 class="entry-title text-white text-uppercase m-0 mt-5"><a href="#">This is a
                                                standard post with thumbnail</a></h4>
                                    </div>
                                </div>
                            </div>
                            <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius
                                illum libero dolor nobis deleniti, sint assumenda. Pariatur iste veritatis excepturi,
                                ipsa optio nobis.</p>
                            <a
                                href="#"
                                class="btn btn-default btn-sm btn-theme-colored mt-10"
                            >Read more</a>
                        </div>
                    </article>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="owl-carousel-6col clients-logo transparent text-center">
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w1.png"
                                alt=""
                            ></a></div>
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w2.png"
                                alt=""
                            ></a></div>
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w3.png"
                                alt=""
                            ></a></div>
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w4.png"
                                alt=""
                            ></a></div>
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w5.png"
                                alt=""
                            ></a></div>
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w6.png"
                                alt=""
                            ></a></div>
                    <div class="item"> <a href="#"><img
                                src="fundpro/images/clients/w3.png"
