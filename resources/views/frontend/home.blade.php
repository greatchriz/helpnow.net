...
<!-- Mirrored from kodesolution.com/html/2017/fundpro-html/demo/index-sp-layout5.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 May 2023 13:49:19 GMT -->
<head>
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-8">
            <div class="widget no-border m-0">
              <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="index-mp-layout1.html"><img src="images/logo-wide.png" alt=""></a>
            </div>
          </div>
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider rev_slider_fullscreen" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg17.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg16.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg16.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg9.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg9.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
          ...
          <div class="col-md-12">
            <div class="divider call-to-action sm-text-center pt-10 pb-30">
              <div class="col-md-7">
                ...
                <h5 class="text-white mt-5">Changing lives to make easier for child education and drinking water!</h5>
                <a class="btn btn-default btn-flat mt-10 mb-5" href="#">Join Now</a>
              </div>
              <div class="col-md-5">
                <div class="text-center text-white font-13 pt-30 mt-5" data-countdown="2019/09/01"></div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 pb-sm-20">
              ...
              <div class="image-box-thum">
                <iframe src="http://player.vimeo.com/video/10260175?title=0&amp;byline=0&amp;portrait=0" height="210"  title="Volunteer policy" allowfullscreen></iframe>
              </div>
              <div class="image-box-details pt-20 pb-sm-20">
                <p class="lead mb-15">Lorem ipsum dolor sit amet, Crowdfunding adipisicing elit Quis ipsa ullam dicta suscipit ipsum porro molestias</p>
            ...
            <div class="col-sm-6 col-md-4 pb-sm-20">
              <h3 class="line-bottom border-bottom mt-0">Become a Volunteer</h3>
              <img src="images/about/ab1.png" alt="">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              ...
              <form id="paypal_donate_form_onetime_recurring" class="form p-30" data-bg-img="images/about/f1.jpg">
                <div class="row">
                  <div class="col-md-12">
                    <h3 class="text-white line-bottom mt-0 mb-30">Make a <span class="text-theme-colored">Donation</span> Now</h3>
    ...
    <section id="contact" class="divider bg-silver-light">
      <div class="container pt-60 pb-60">
        ...
        <div class="row pt-10">
          <div class="col-md-10 col-md-offset-1">
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="https://kodesolution.com/html/2017/fundpro-html/demo/includes/sendmail.php" method="post">
          ...
          <div class="widget dark">
            ...
            <div class="latest-posts">
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb"><img alt="" src="https://www.placeholder.com/80x55"></a>
...
<!-- Mirrored from kodesolution.com/html/2017/fundpro-html/demo/index-sp-layout5.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 May 2023 13:49:22 GMT -->
</html>
